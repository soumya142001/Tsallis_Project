...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  4 12:18:33 2023
...
data = np.genfromtxt('CERN_ISR_Pn_n_62_2.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='CERN ISR Data at $\sqrt{s}=62.2$GeV')
