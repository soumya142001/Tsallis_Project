...
plt.plot(V/(a**3),temp[0][:],label='$\sqrt{s}=30.4$ GeV',linewidth=4)
plt.plot(V/(a**3),temp[1][:],label='$\sqrt{s}=44.5$ GeV',linewidth=6)
plt.plot(V/(a**3),temp[2][:],label='$\sqrt{s}=52.6$ GeV',linewidth=3)
plt.plot(V/(a**3),temp[3][:],label='$\sqrt{s}=62.2$ GeV',linewidth=4)

plt.xlabel('V (fm$^3$)',fontsize=40)
plt.ylabel(r' $\beta^{-1}$  (MeV)',fontsize=40)
plt.xticks(range(20,161,20),fontweight='bold',fontsize=20)
plt.yticks(range(100,181,10),fontweight='bold',fontsize=20)
plt.xlim(20,160)
plt.ylim(100,180)
