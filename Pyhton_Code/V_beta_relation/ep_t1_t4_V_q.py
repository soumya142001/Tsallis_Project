...
Nbar=np.array([2.45,4.88,6.42,6.87])
K = np.array([3.283,5.12,10.52,15.86])
...
plt.plot(V/(a**3),Q[2][:],label=r'$\langle Q^2 \rangle=55.0$ GeV$^2$',linewidth=4)
plt.plot(V/(a**3),Q[3][:],label=r'$\langle Q^2 \rangle=385.3$ GeV$^2$',linewidth=4)
