...
plt.plot(V/(a**3),Q[0][:],label='$\sqrt{s}=30.4$ GeV',linewidth=4)
plt.plot(V/(a**3),Q[1][:],label='$\sqrt{s}=44.5$ GeV',linewidth=4)
plt.plot(V/(a**3),Q[2][:],label='$\sqrt{s}=52.6$ GeV',linewidth=4)
plt.plot(V/(a**3),Q[3][:],label='$\sqrt{s}=62.2$ GeV',linewidth=4)

plt.xlabel('V (fm$^3$)',fontsize=40)
plt.ylabel('q-1',fontsize=40)
plt.xticks(np.arange(20,161,20),fontweight='bold',fontsize=20)
plt.yticks(np.arange(0,0.021,0.002),fontweight='bold',fontsize=20)
plt.xlim(20,160)
plt.ylim(0,0.02)
