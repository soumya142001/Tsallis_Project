...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  5 02:10:23 2023
...
data = np.genfromtxt('CERN_ISR_Pn_n_52_6.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='CERN ISR Data at $\sqrt{s}=52.6$GeV')
