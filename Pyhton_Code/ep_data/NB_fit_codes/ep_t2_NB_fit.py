...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 14:53:36 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/ep_data/ep-H1-data/ep-H1-data/ep_py_data/t2-epH1_py.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='ep-t2 data')
...
plt.savefig('/home/soumya/Tsallis_Data/Plots/ep_plots/t2_plots/ep_t2_NB_fit.png')
