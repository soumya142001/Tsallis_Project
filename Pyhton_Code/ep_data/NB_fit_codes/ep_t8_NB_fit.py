...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/ep_data/ep-H1-data/ep-H1-data/ep_py_data/t8-epH1_py.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='ep-t8 data')
...
plt.savefig('/home/soumya/Tsallis_Data/Plots/ep_plots/t8_plots/ep_t8_NB_fit.png')
