...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/ep_data/ep-H1-data/ep-H1-data/ep_py_data/t4-epH1_py.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='ep-t4 data')
...
plt.savefig('/home/soumya/Tsallis_Data/Plots/ep_plots/t4_plots/ep_t4_NB_fit.png')
