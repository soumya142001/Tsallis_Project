...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  5 21:09:44 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/ep_data/ep-H1-data/ep-H1-data/ep_py_data/t1-epH1_py.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='ep-t1 data')
...
plt.savefig('/home/soumya/Tsallis_Data/Plots/ep_plots/t1_plots/ep_t1_NB_fit.png')
print('#### Ending ep-t1 ####')
