...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 14:25:46 2023
...
#solution, info_dict =  fsolve(Tsallis_vdwaal,(0.001,0.02), full_output=True)
...
# #print("Solution: x = {0:.5f}, y = {1:.5f}".format(x, y))
# #print("Error estimate: {0:.5e}".format(info['fvec'].max()))
