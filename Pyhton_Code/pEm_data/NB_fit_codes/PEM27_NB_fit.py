...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/pEm_data/p-em-data/p-em-data/PEM27.txt')
...
plt.text(25,0.05,s,fontsize=15,bbox=dict(facecolor='orange', alpha=0.5))
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='PEM27 data')
