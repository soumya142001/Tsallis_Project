...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 12:53:18 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/pEm_data/p-em-data/p-em-data/PEM400.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='PEM400 data')
