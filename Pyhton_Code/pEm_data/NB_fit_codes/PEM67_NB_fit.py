...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/pEm_data/p-em-data/p-em-data/PEM67.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='PEM67 data')
