...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 12:53:19 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/pEm_data/p-em-data/p-em-data/PEM800.txt')
...
plt.text(35,0.03,s,fontsize=15,bbox=dict(facecolor='orange', alpha=0.5))
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='PEM800 data')
