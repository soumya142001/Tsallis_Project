...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  5 01:31:22 2023
...
data = np.genfromtxt('CERN_ISR_Pn_n_30_4.txt')
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='CERN ISR Data at $\sqrt{s}=30.4$GeV')
