...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 03:00:22 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/had_nucl_code/had_nucl_data/had_nucl_data/pi_minus_Ne_30.txt')
...
plt.text(35,0.08,s,fontsize=15,bbox=dict(facecolor='orange', alpha=0.5))
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='pi_minus_Ne_30 data')
