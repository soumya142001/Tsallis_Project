...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 03:09:14 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/had_nucl_code/had_nucl_data/had_nucl_data/pW_400.txt')
...
plt.text(35,0.04,s,fontsize=15,bbox=dict(facecolor='orange', alpha=0.5))
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='pW_400 data')
