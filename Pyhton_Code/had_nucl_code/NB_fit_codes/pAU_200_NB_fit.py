...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  6 17:54:00 2023
...
data = np.genfromtxt('/home/soumya/Tsallis_Data/Pyhton_Code/had_nucl_code/had_nucl_data/had_nucl_data/pAU_200.txt')
...
plt.text(35,0.20,s,fontsize=15,bbox=dict(facecolor='orange', alpha=0.5))
...
plt.errorbar(N,prob_N,yerr = err_prob_N, fmt='o',label='pAU_200 data')
