...
void ppbar_200_NBfit()
{
  ...
  fstream file("/home/soumya/Tsallis_Data/ROOT_fit_Code/ppbar/Data_ppbar/ppbar_200.txt",ios::in);
 ...
 for(int i=0;i<100;i++)
  ...
  while(!file.eof())
  {
   ...
   legend->AddEntry(gr,"ppbar 200 data","ep");
   legend->Draw();
   
   gStyle->SetOptFit(1111);
  
   c1->SaveAs("plots/ppbar_200_NBfit.pdf");
