...
void ep_t3_NBfit()
{
  ...
  fstream file("/home/soumya/Tsallis_Data/Pyhton_Code/ep_data/ep-H1-data/ep-H1-data/ep_py_data/t3-epH1_py.txt",ios::in);
 ...
 for(int i=0;i<100;i++)
  ...
  while(!file.eof())
  {
   ...
   c1->SaveAs("/home/soumya/Tsallis_Data/Plots/NB_fit_Plots/ep_t3_NBfit.pdf");
