...
void ISR_52_6_NBfit()
{
  ...
  fstream file("/home/soumya/Tsallis_Data/Pyhton_Code/CERN_ISR_52_6/CERN_ISR_Pn_n_52_6.txt",ios::in);
 ...
 for(int i=0;i<100;i++)
  ...
  while(!file.eof())
  {
   ...
   c1->SaveAs("/home/soumya/Tsallis_Data/Plots/NB_fit_Plots/ISR_52_6_NBfit.pdf");
