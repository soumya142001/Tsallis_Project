...
void ISR_30_4_NBfit()
{
  ...
  fstream file("/home/soumya/Tsallis_Data/Pyhton_Code/CERN_ISR_30_4/CERN_ISR_Pn_n_30_4.txt",ios::in);
 ...
 for(int i=0;i<100;i++)
  ...
  while(!file.eof())
  {
   ...
   for(int i=0;i<c;i++){
   cout<<"i:	"<<i<<"	"<<"N[i]:	"<<N[i]<<"	"<<"PN[i]:	"<<PN[i]<<endl;
   }
   ...
   gr->Draw("APE");
   gr->GetYaxis()->SetRangeUser(-0.02,0.20);
   ...
   c1->SaveAs("/home/soumya/Tsallis_Data/Plots/NB_fit_Plots/ISR_30_4_NBfit.pdf");
