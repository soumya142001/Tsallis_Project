...
void ISR_62_2_NBfit()
{
  ...
  fstream file("/home/soumya/Tsallis_Data/Pyhton_Code/CERN_ISR_62_2/CERN_ISR_Pn_n_62_2.txt",ios::in);
 ...
 for(int i=0;i<100;i++)
  ...
  while(!file.eof())
  {
   ...
   c1->SaveAs("/home/soumya/Tsallis_Data/Plots/NB_fit_Plots/ISR_62_2_NBfit.pdf");
